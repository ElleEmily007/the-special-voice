    ...
    <section className="gradient-navy py-20 px-4 text-center">
      <div className="max-w-2xl mx-auto">
        ...
        <p className="text-white/60 mb-8 leading-relaxed">
          Start your free trial today. Trial length depends on your plan (9, 6, or 3 days). A card
          is required to start, but you won&apos;t be charged until the trial ends. Just open your
          voicemail and let the story come to you.
        </p>
        <Link
          href="/optin"
